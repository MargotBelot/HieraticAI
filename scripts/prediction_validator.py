...
class PredictionValidator:
    def __init__(self):
        ...
        self.aku_data_path = Path("/Users/margot/Desktop/ALP_project/AKU Westcar Scraping")
    ...
    def get_tla_lemmas_for_sign(self, gardiner_code: str) -> List[Dict]:
        ...
        manual_entries = {
            'A14': [{'hieroglyphs': '𓀐', 'transliteration': 'dwꜣ', 'translation': 'To worship; to adore', 'frequency': 0, 'lemma_id': 'MANUAL_A14', 'source': 'Gardiner + Manual'}],
            'A49': [{'hieroglyphs': '𓕝', 'transliteration': 'ꜥꜣmw', 'translation': 'Asiatic; Syrian (determinative)', 'frequency': 0, 'lemma_id': 'MANUAL_A49', 'source': 'Gardiner + Manual'}],
            ...
            'F9': [{'hieroglyphs': '𓄇', 'transliteration': 'pẖr', 'translation': 'Leopard (determinative)', 'frequency': 0, 'lemma_id': 'MANUAL_F9', 'source': 'Gardiner + Manual'}],
            'I1': [{'hieroglyphs': '𓆈', 'transliteration': 'ꜣsf', 'translation': 'Gecko; lizard (determinative)', 'frequency': 0, 'lemma_id': 'MANUAL_I1', 'source': 'Gardiner + Manual'}],
            'M5': [{'hieroglyphs': '𓆴', 'transliteration': 'jšd', 'translation': 'Tree; wood (determinative)', 'frequency': 0, 'lemma_id': 'MANUAL_M5', 'source': 'Gardiner + Manual'}],
            'N90': [{'hieroglyphs': '𓋢', 'transliteration': 'mw', 'translation': 'Water; liquid (determinative)', 'frequency': 0, 'lemma_id': 'MANUAL_N90', 'source': 'Gardiner + Manual'}],
            ...
            'R10': [{'hieroglyphs': '𓊻', 'transliteration': 'ḥb', 'translation': 'Festival; celebration', 'frequency': 0, 'lemma_id': 'MANUAL_R10', 'source': 'Gardiner + Manual'}],
            'S33': [{'hieroglyphs': '𓋸', 'transliteration': 'tbw.t', 'translation': 'Sandal; shoe', 'frequency': 0, 'lemma_id': 'MANUAL_S33', 'source': 'Gardiner + Manual'}],
            'U9': [{'hieroglyphs': '𓌽', 'transliteration': 'hnw', 'translation': 'Jar; grain measure', 'frequency': 0, 'lemma_id': 'MANUAL_U9', 'source': 'Gardiner + Manual'}],
            'Y4': [{'hieroglyphs': '𓏟', 'transliteration': 'mn', 'translation': 'Gaming piece; draughtsman', 'frequency': 0, 'lemma_id': 'MANUAL_Y4', 'source': 'Gardiner + Manual'}],
            'Z3A': [{'hieroglyphs': '𓏫', 'transliteration': '3', 'translation': 'Three (strokes); plural marker', 'frequency': 0, 'lemma_id': 'MANUAL_Z3A', 'source': 'Gardiner + Manual'}],
            'D45': [{'hieroglyphs': '𓂦', 'transliteration': 'ḏsr', 'translation': 'Arm with sacred objects', 'frequency': 0, 'lemma_id': 'MANUAL_D45', 'source': 'Gardiner + Manual'}],
