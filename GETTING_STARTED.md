...
- [One-Click Installation (Recommended)](#one-click-installation-recommended)
  - [Step 1: Download HieraticAI](#step-1-download-hieraticai)
  - [Step 2: Run the Automatic Installer](#step-2-run-the-automatic-installer)
  - [Step 3: Launch HieraticAI](#step-3-launch-hieraticai)
...
- [Step 1: Install Required Software](#step-1-install-required-software)
  - [Option A: Using the Python Installer (Recommended for Beginners)](#option-a-using-the-python-installer-recommended-for-beginners)
  - [Option B: Manual Installation](#option-b-manual-installation)
- [Step 2: Download HieraticAI](#step-2-download-hieraticai)
  - [Method 1: Download as ZIP (Easy for Beginners)](#method-1-download-as-zip-easy-for-beginners)
  - [Method 2: Using Git (Recommended)](#method-2-using-git-recommended)
- [Step 3: Install HieraticAI Dependencies](#step-3-install-hieraticai-dependencies)
  - [For Most Users (Simple Method)](#for-most-users-simple-method)
  - [For Advanced Users (Using Conda)](#for-advanced-users-using-conda)
  - [Verify Everything Worked](#verify-everything-worked)
- [Step 4: Launch HieraticAI](#step-4-launch-hieraticai)
  - [Easy Launch Method](#easy-launch-method)
  - [What to Expect](#what-to-expect)
  - [You're Ready to Use HieraticAI](#youre-ready-to-use-hieraticai)
- [Using HieraticAI (Detailed Guide)](#using-hieraticai-detailed-guide)
  - [Method 1: Using Conda (Recommended)](#method-1-using-conda-recommended)
  - [Method 2: Using pip](#method-2-using-pip)
- [Database Setup](#database-setup)
  - [TLA Database Integration](#tla-database-integration)
  - [AKU Database Setup](#aku-database-setup)
- [First Launch](#first-launch)
  - [Launch the Validation Interface](#launch-the-validation-interface)
  - [Expected Output](#expected-output)
  - [Interface Tour](#interface-tour)
- [Your First Validation Session](#your-first-validation-session)
  - [Step 1: Understand the Interface](#step-1-understand-the-interface)
  - [Step 2: Adjust Confidence Threshold](#step-2-adjust-confidence-threshold)
  - [Step 3: Select Your First Prediction](#step-3-select-your-first-prediction)
  - [Step 4: Review the Sign Context](#step-4-review-the-sign-context)
  - [Step 5: Make Your First Validation](#step-5-make-your-first-validation)
  - [Step 6: Track Your Progress](#step-6-track-your-progress)
- [Best Practices for Validation](#best-practices-for-validation)
  - [Academic Validation Approach](#academic-validation-approach)
  - [Efficiency Tips](#efficiency-tips)
- [Customization Options](#customization-options)
  - [Adjust Interface Settings](#adjust-interface-settings)
