...
class PredictionValidator:
    def __init__(self):
        ...
        self.predictions_file = self._find_predictions_file()

        self.validation_file = self.project_root / "output" / "validation_results.json"

        # Use clean-split dataset (generated by Colab notebook)
        self.images_dir = self.project_root / "dataset_clean"
    ...
    def _find_predictions_file(self) -> Path:
        """Auto-discover predictions file from available output directories.
