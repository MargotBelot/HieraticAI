...
def setup_args():
    ...
    parser.add_argument(
        "--output-dir", default="output", help="Output directory for training results"
    )
    parser.add_argument(
        "--model-weights",
        default=None,
    ...
    parser.add_argument(
        "--max-iter", type=int, default=15000, help="Maximum training iterations"
    )
    parser.add_argument(
        "--eval-period", type=int, default=2000, help="Evaluation period (iterations)"
    )
    parser.add_argument(
