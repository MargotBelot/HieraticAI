...
def create_system_architecture_diagram():
    ...
    # Title
    fig.suptitle(
        "HieraticAI System Architecture", fontsize=24, fontweight="bold", y=0.95
    )
    ...
    ax.text(
        2.5, 12, "INPUT LAYER", fontsize=14, fontweight="bold", ha="center", va="center"
    )
    ax.text(
        2.5,
        11.5,
        "• Westcar Papyrus Images\n• High-resolution scans\n• TIFF/PNG format",
        fontsize=10,
        ha="center",
        va="center",
    )
    ...
    # AI sub-components
    resnet_box = Rectangle(
        (6.5, 11.6), 2.2, 0.6, facecolor="white", alpha=0.9, edgecolor="black"
    )
    ...
    rpn_box = Rectangle(
        (9, 11.6), 2.2, 0.6, facecolor="white", alpha=0.9, edgecolor="black"
    )
    ...
    classifier_box = Rectangle(
        (11.5, 11.6), 2.2, 0.6, facecolor="white", alpha=0.9, edgecolor="black"
    )
    ...
    ax.text(
        10,
        11.2,
        "Faster R-CNN + Detectron2 Framework",
        fontsize=10,
        ha="center",
        va="center",
        style="italic",
    ...
    ax.arrow(
        17, 11, 0, -1, head_width=0.2, head_length=0.2, fc="gray", ec="gray", alpha=0.7
    )

    # To Output
    ax.arrow(
        15, 10, -2.5, -3.2, head_width=0.2, head_length=0.2, fc="black", ec="black"
    )
...
def create_validation_workflow_diagram():
    ...
    # Title
    fig.suptitle(
        "HieraticAI Validation Workflow", fontsize=22, fontweight="bold", y=0.95
    )
    ...
    steps = [
        {
            "pos": (2, 10),
            "size": (3, 1.5),
            "title": "1. LOAD PREDICTIONS",
            "content": "• AI Model Results\n• COCO Format\n• Confidence Scores",
        },
        {
            "pos": (7, 10),
            "size": (3, 1.5),
            "title": "2. FILTER BY THRESHOLD",
            "content": "• Adjustable Slider\n• Confidence ≥ 0.3\n• Focus on Uncertain",
        },
        {
            "pos": (12, 10),
            "size": (3, 1.5),
            "title": "3. SELECT PREDICTION",
            "content": "• Click Bounding Box\n• View Cropped Sign\n• Show Metadata",
        },
        {
            "pos": (2, 7.5),
            "size": (3, 1.5),
            "title": "4. LOAD CONTEXT",
        ...
        },
        {
            "pos": (12, 7.5),
            "size": (3, 1.5),
            "title": "6. MAKE DECISION",
            "content": "• [OK] Correct\n• [X] Incorrect\n• [?] Uncertain",
        },
        {
            "pos": (2, 5),
            "size": (3, 1.5),
            "title": "7. UPDATE DATABASE",
            "content": "• Store Validation\n• Track Progress\n• Calculate Stats",
        },
        {
            "pos": (7, 5),
            "size": (3, 1.5),
            "title": "8. SHOW PROGRESS",
    ...
    # Add workflow arrows
    arrow_pairs = [(0, 1), (1, 2), (2, 5), (5, 4), (4, 3), (3, 6), (6, 7), (7, 8)]
    ...
    ax.text(
        8.5,
        2,
        "Real-time statistics • Progress tracking • CSV export",
        fontsize=10,
        ha="center",
        style="italic",
    )
...
def create_database_integration_diagram():
    ...
    # Title
    fig.suptitle(
        "Database Integration Architecture", fontsize=20, fontweight="bold", y=0.95
    )

    # Central Gardiner Code
    center_circle = Circle(
        (8, 5), 1.5, facecolor="gold", alpha=0.8, edgecolor="black", linewidth=3
    )
...
def create_research_methodology_diagram():
    ...
    # Title
    fig.suptitle(
        "HieraticAI: Academic Research Methodology",
        fontsize=22,
        fontweight="bold",
        y=0.95,
    )
    ...
    phases = [
        ...
        },
        {
            ...
            "color": "#27ae60",
            "content": "• Expert validation interface\n• TLA/AKU integration\n• Statistical analysis\n• Academic review",
        },
        {
            "pos": (3, 6.5),
            "size": (4, 1.8),
    ...
    ax.text(
        9,
        0.8,
        "Freie Universität Berlin • Ancient Language Processing Seminar",
        fontsize=11,
        fontweight="bold",
        ha="center",
    )
