...
class TestDatasetValidator(unittest.TestCase):
    ...
    def test_file_structure_validation_success(self):
        ...
        self.assertEqual(
            len(validator.validation_results["file_structure"]["missing_paths"]), 0
        )
    ...
    def test_category_id_validation_1_based(self):
        ...
        self.assertFalse(
            validator.validation_results["category_ids"]["detectron2_compatible"]
        )
    ...
    def test_category_id_validation_0_based(self):
        ...
        self.assertTrue(result)
        self.assertFalse(
            validator.validation_results["category_ids"]["needs_remapping"]
        )
        self.assertTrue(
            validator.validation_results["category_ids"]["detectron2_compatible"]
        )
    ...
    def test_detectron2_compatibility_with_remapping_needed(self):
        ...
        self.assertTrue(
            validator.validation_results["detectron2_compatibility"][
                "needs_category_remapping"
            ]
        )
        self.assertGreater(
            len(validator.validation_results["detectron2_compatibility"]["issues"]), 0
        )
...
class TestIntegration(unittest.TestCase):
    ...
    def create_realistic_mock_dataset(self):
        ...
        for split in splits:
            ...
            coco_data = {
                "info": {"description": "Test hieroglyph dataset", "version": "1.0"},
                "images": images,
...
class TestRegressionPrevention(unittest.TestCase):
    ...
    def test_category_mapping_regression_prevention(self):
        ...
        self.assertEqual(
            len(overlap), 0, "Off-by-one error detected: no category overlap"
        )
        ...
        self.assertEqual(
            len(overlap_after_fix), 1, "After remapping, categories should align"
        )
