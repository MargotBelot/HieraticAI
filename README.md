...
graph LR
    ...
    AI1 --> AI2[<b>Data</b><br/><b>Augmentation</b><br/>Rotation ±15°, flip<br/>Brightness, contrast<br/>RandomExtent]
    AI2 --> AI3[<b>Model Training</b><br/>Google Colab A100<br/>Faster R-CNN<br/>ResNet-50<br/>95 categories<br/>30,000 iterations]
    AI3 --> AI5[<b>Trained Model</b><br/>mAP: 36.4% TTA<br/>AP50: 59.7%]
...
| **Categories** | 95 active Gardiner code classes (from pWestcar) |
| **mAP (standard)** | 30.9% (IoU=0.50:0.95) |
| **mAP (with TTA)** | 36.4% (IoU=0.50:0.95), AP50: 59.7% |
| **Training Split** | 455 train / 67 val / 58 test (Y-band spatial split, 30px buffer) |
| **TLA Coverage** | 100% (with fallback strategies) |
| **AKU Integration** | Reference signs from Westcar corpus |
| **Validation Interface** | Streamlit-based real-time review |
...
```
HieraticAI/
├── data/                           # Source data and generated indices
│   ├── annotations.json            # Master CVAT annotations (605 signs)
│   ├── train_val.png               # Source papyrus image
│   ├── aku_gardiner_index.json     # AKU database index (auto-generated)
│   └── tla_lemma_index.json        # TLA database index (auto-generated)
├── dataset_clean/                  # Training dataset (generated by Colab notebook)
│   ├── train/                      # 25 patches, 3741 annotations
│   ├── val/                        # 5 patches, 179 annotations
│   └── test/                       # 5 patches, 157 annotations
├── output_clean_split/             # Training outputs (generated by Colab notebook)
│   ├── model_final.pth             # Trained model weights
│   ├── eval_test/                  # Standard evaluation results
│   └── eval_test_tta/              # TTA evaluation results
├── configs/                        # Training and evaluation configs
├── notebooks/                      # Colab training notebook
│   └── 01_Training.ipynb           # Complete train + eval pipeline
├── external_data/                  # External database files
│   └── AKU Westcar Scraping/       # AKU Westcar papyrus data
└── tools/                          # Scripts and utilities
    ├── training/                   # Local training script
    ├── validation/                 # Streamlit validation interface
    ├── evaluation/                 # Evaluation and accuracy tools
    └── data-collection/            # Hieroglyph scraping toolkit
```

> **Note**: `dataset_clean/` and `output_clean_split/` are generated by the Colab notebook and gitignored.
> To reproduce, run `notebooks/01_Training.ipynb` on Google Colab with an A100 GPU.
