...
1. Download the ZIP from [GitHub](https://github.com/MargotBelot/HieraticAI)
2. Extract and run: `python3 install.py`
3. **macOS/Linux**: Double-click **HieraticAI** on your Desktop or run `./start_hieratic_ai.sh`
4. **Windows**: Double-click **HieraticAI** shortcut or `start_hieratic_ai.bat`
...
source hieratic_env/bin/activate  # or: hieratic_env\Scripts\activate (Windows)
pip install -r requirements.txt
streamlit run tools/validation/prediction_validator.py
```

> **Note**: Model loads in 30-60 seconds on first run. Keep terminal window open while using.
...
```
HieraticAI/
├── data/                    # Source annotations & indices
├── dataset_clean/           # Training dataset (auto-generated)
├── model/                   # Trained model weights & results
├── configs/                 # Training configs
├── notebooks/01_Training.ipynb  # Colab training pipeline
├── tools/
│   ├── validation/          # Streamlit interface
│   ├── training/            # Local training
│   ├── evaluation/          # Metrics & analysis
│   └── data-collection/     # Hieroglyph scraper
├── utils/                   # Shared utilities
├── tests/                   # Test suite
└── scripts/                 # Maintenance scripts
```

For details, see [TECHNICAL_GUIDE.md](docs/TECHNICAL_GUIDE.md#project-structure).
